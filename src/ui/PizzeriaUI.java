...
public class PizzeriaUI extends JFrame {
    ...
    public PizzeriaUI() {
        ...
        comboBoxLasagna
                .setModel(new DefaultComboBoxModel(LasagnaType.values()));
    ...
    public static void main(final String[] args) {
        final PizzeriaUI ventana = new PizzeriaUI();
