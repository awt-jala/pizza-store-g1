...
public class LasagnaBranchB extends Lasagna {
    private static final double LASAGNA_COST_BASE = 6;
    ...
    public LasagnaBranchB() {
        ...
        ing3.setIngredientsType(IngredientType.MARINARA_SAUCE);
        ing3.setPrice();
